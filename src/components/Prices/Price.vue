<template>
  <div id="prices">
    <p class="displayText">Nur noch {{ ticketsLeft }} Tickets vorhanden.</p>
      ...
      >
        <div class="decreaseIncreaseButton">
          ...
          >
            ...
            <line x1="7" y1="14" x2="7" stroke="black" stroke-width="2" />
          </svg>
        </div>
      </div>
    ...
    <div class="totalPrice">{{ priceTotal }} euros</div>
    <div class="positionButton">
      <div class="submitButtonContainer">
        <div class="submitButton" @click="submitBooking">
          <div class="buttonText">Jetzt buchen</div>
        </div>
      </div>
    </div>
  </div>
